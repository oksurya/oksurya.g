...
<header class="border-b mx-auto max-w-2xl text-center">
        <h1 itemprop="headline" class="no-typography font-bold">Age Calculator</h1>
        <p class="mt-2 text-sm  font-semibold text-gray-400">Calculate your age with our easy-to-use age calculator tool</p>
