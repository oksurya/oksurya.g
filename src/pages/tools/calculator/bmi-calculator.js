...
<header class="border-b mx-auto max-w-2xl text-center">
        <h1 itemprop="headline" class="no-typography font-bold">BMI Calculator</h1>
        <p class="mt-2 text-sm  font-semibold text-gray-500">Your Weight with Our Personalized BMI Calculator with Age and Gender</p>
