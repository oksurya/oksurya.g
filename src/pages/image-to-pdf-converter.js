...
function ImageToPDFConverter() {
  ...
  <div onDragOver={handleDragOver} onDrop={handleDrop} class="mmax-w-2xl prose mx-auto mt-10 lg:text-lg">
    ...
    <label
        ...
        <div className="text-center w-full p-4 border-2 border-dashed border-gray-300">
        <input type="file" accept="image/*" onChange={handleImageChange} class="bg-purple-800 text-white py-2 px-4 rounded-lg hover:bg-purple-700 focus:outline-none focus:bg-purple-800"/>
        </div>
   </label>
