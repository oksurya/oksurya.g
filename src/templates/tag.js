...
export const Head = ({ pageContext }) => {
  ...
  return <Seo title={`${tag}: Tech Guides and Tutorials`} description={`Explore ${tag} with our tech guides and tutorials. Learn how to build fast, dynamic websites with ${tag}. Discover everything you need to know to get started today.`} />
}
